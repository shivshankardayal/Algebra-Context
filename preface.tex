...
I have used {\tt Asymptote}, and \MetaPostLogo~ for drawing all the diagrams.
Both are wonderful
...
\MetaPostLogo.  \MetaPostLogo~ is equally powerful(at least for 2D graphics) and it is closely integrated with \ConTeXt{}, which
makes it default choice for making graphics. The problem with Asymptote is that because it uses \LaTeX{} so a huge installation
