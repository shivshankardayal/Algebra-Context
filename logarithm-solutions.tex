...
\item Given $\log_{\sqrt{5}}.008 = 2\log_5\frac{8}{1000} = 2[\log_58 - \log_51000] = 2[\log_58 - \log 8.125]$
  ...
  $= 2[\log_58 - \log_58 - \log_5125] = -2.\log_55^3 = -6$.
...
\item L.H.S. $= \frac{\log_a\log_ba}{\log_b\log_ab}$
  ...
  Let $\log_ba = z$, then L.H.S. $= \frac{\log_az}{\log_b\tfrac{1}{z}} = -\frac{\log_az}{\log_bz} = -\frac{\log z}{\log a}.\frac{\log b}{\log z}$
...
\item We can use the fact that the number of positive integers having base $b$ and characteristics $n$ is $b^{n + 1} - b^n$.
  ...
  Thus, number of integer with base $3$ and characteristics $2$ is $3^3 - 3^2 = 18$.
...
\item Given $a, b, c$ are in G.P. $\Rightarrow \frac{b}{a} = \frac{c}{b}$. Taking $\log_x$ of these
  ...
  $\log_xb - \log_xa = \log_xc - \log_xb \Rightarrow 2\log_xb = \log_xc + \log_xa$. Thus, $\log_xa, \log_xb, \log_xc$
...
\item $\log_2x + \log_4(x + 2) = 2 \Rightarrow \log_2x + \frac{1}{2}\log_2(x + 2) = 2$
  ...
  $\Rightarrow 2\log_2x + \log_2(x + 2) = 4 \Rightarrow \log_2x^2(x + 2) = 4$
...
\item Given, $3^{4\log_9(x + 1)} = 2^{\log_2(x^2 + 3)}$
...
\item $\frac{6}{5}a^{\log_ax\log_{10}a\log_a5} - 3^{\log_{10}\tfrac{x}{10}} = 9^{\log_{100}x + \log_42}$
  ...
  $\Rightarrow \frac{6}{5}\left(a^{\log_a5}\right)^{\log_{10}x} - 3^{\log_{10}x - 1} = 3^{\log_{10}x + 1}$
...
\item Given, $2^{3x + \tfrac{1}{2}} + 2^{x + \tfrac{1}{2}} = 2^{\log_26}$
  ...
  $\Rightarrow (2^x)^3 + 2^x = 3\sqrt{2} \Rightarrow 2^x = \sqrt{2}, \frac{-\sqrt{2} \pm \sqrt{-10}}{2}$
...
\item $2\log_{10}x - \log_x{.01}\geq 4$
...
\item $a = \log_{\tfrac{1}{2}}\sqrt{0.125} > 0$ because both base and number are less than $1$.
  ...
  $b = \log_3\left(\frac{1}{\sqrt{24} - \sqrt{17}}\right) = \log_3\left(\frac{\sqrt{24} + \sqrt{17}}{7}\right) > 0$
...
\item Given $e^{-\tfrac{\pi}{2}} < \theta < \frac{\pi}{2}$
  ...
  $\Rightarrow -\frac{\pi}{2} < \log_e\theta < 1 < \frac{\pi}{2}$
...
\item Given, $\log_2x + \log_2y \geq 6\Rightarrow \log_2xy \geq 6 \Rightarrow xy \geq 64$
  ...
  A.M $\geq$ G.M $\Rightarrow \frac{x + y}{2} \geq \sqrt{xy} \Rightarrow x + y \geq 16$.
...
\item Given, $y = 10^{\frac{1}{1 - \log x}} \Rightarrow \log y = \frac{1}{1 - \log x}$, and similarly, $\log z = \frac{1}{1 - \log y}$
  ...
  $\Rightarrow z = \frac{1}{1 - \frac{1}{1 - \log x}} = \frac{1 - \log x}{-\log x} = -\frac{1}{\log x} + 1\Rightarrow x = 10^{\frac{1}{1 - \log z}}$.
...
\item Given $\log_712 = a$ and $\log_{12}24 = b$
  ...
  Similarly, $8a = \log_712^8$ and $5ab = \log_724^5$
