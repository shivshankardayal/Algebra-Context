...
\item If $z_1 + z_2 + z_3 = \alpha, z_1 + z_2\omega + z_3\omega^2 = \beta$ and $z_1 + z_2\omega^2 +
  z_3\omega = \gamma$, express $z_1, z-_z, z_3$ in terms of $\alpha, \beta, \gamma$. Hence prove that
...
\item If $a_i, b_i\in R, i = 1, 2, \ldots, n$, show that $\displaystyle\left(\sum_{n = 1}^na_i\right)^2 +
  \left(\sum_{n = 1}^nb_i\right)^2 \leq \left(\sum_{n = 1}^n\sqrt{a_i^2 + b_i^2}\right)^2$.
...
\item Let $x$ and $a$ be positive numbers. Determine the greatest term in the expansion of $(x + a)^n$.
