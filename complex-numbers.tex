...
\startformula = \frac{\startdeterminant\NC|z_1|^2 \NC z_1 NC 1\NR\NC |z_2|^2 \NC z_2 \NC 1 \NR\NC |z_3|^2 \NC z_3 \NC 1\NR\stopdeterminant}{\startdeterminant\NC\overline{z_1} \NC z_1 \NC 1\NR\NC\overline{z_2} NC z_2 \NC 1\NR\NC\overline{z_3} \NC z_3 \NC 1 \NR\stopdeterminant}\stopformula
...
\startformula z = \frac{\startdeterminant\NC z_1^2 \NC \overline{z_1} NC 1\NR\NC z_2^2 \NC \overline{z_2} \NC 1\NR\NC z_3^2 \NC \overline{z_3} \NC 1\NR\stopdeterminant + \startdeterminant \NC|z_1|^2 NC z_1 NC 1\NR\NC|z_2|^2 \NC z_2 \NC 1\NR\NC|z_3|^2 \NC z_3 \NC 1\NR\stopdeterminant}{\startdeterminant\NC\overline{z_1} \NC z_1 NC 1\NR\NC\overline{z_2} \NC z_2 \NC 1\NR\NC\overline{z_3} \NC z_3 \NC 1\NR\stopdeterminant}\stopformula
...
\startformula x_1 + x_2 + \ldots + x_n = -p_1\stopformula
\startformula x_1x_2 + x_1x_3 + \ldots + x_1x_n + x_2x_3 + \ldots + x_{n - 1}x_n = -p_2\stopformula
\startformula x_1x_2x_3 + \ldots + x_{n -2}x_{n - 1}x_n = -p_3\stopformula
\startformula \ldots\stopformula
\startformula x_1x_2\ldots x_n = \pm p_n\stopformula
...
\item Find the square root of \startformula \frac{x^2}{y^2} + \frac{y^2}{x^2} - \frac{1}{i}\left(\frac{x}{y} - \frac{y}{x}\right) -
  \frac{9}{4}\stopformula
\item Find the square root of \startformula x^2 + \frac{1}{x^2} + 4i\left(x - \frac{1}{x}\right) - 6\stopformula
...
\item Simplify the following sum: \startformula S = 1 + n\cos\theta + \frac{n(n - 1)}{1.2}\cos2\theta + \ldots = \sum_{k = 0}^n{}^nC_k\cos
  k\theta,\;[{}^nC_0 = 1]\stopformula
\item Simplify the following sum: \startformula S = 1 + n\sin\theta + \frac{n(n - 1)}{1.2}\sin2\theta + \ldots = \sum_{k = 0}^n{}^nC_k\sin
  k\theta,\;[{}^nC_0 = 1]\stopformula
...
\item Without solving the family of equations
  \startformula \frac{x^2}{p^2} + \frac{y^2}{p^2 - b^2} + \frac{z^2}{p^2 - c^2} = 1\stopformula
  \startformula \frac{x^2}{q^2} + \frac{y^2}{q^2 - b^2} + \frac{z^2}{q^2 - c^2} = 1\stopformula
  \startformula \frac{x^2}{r^2} + \frac{y^2}{r^2 - b^2} + \frac{z^2}{r^2 - c^2} = 1\stopformula
  find $x^2 + y^2 + z^2$.
...
\item Prove that if $x_1, x_2, \ldots, x_m$ are $m$ different arbitrary quantities, $f(x)$ is a polynomial of degree less than $m$,
  ...
  \startformula f(x) = f(x_1)\frac{(x - x_2)(x - x_3)\ldots(x - x_m)}{(x_1 - x_2)(x_1 - x_3)\ldots(x_1 - x_m)} +\stopformula
  \startformula f(x_2)\frac{(x - x_1)(x - x_3)\ldots(x - x_m)}{(x_2 - x_2)(x_2 - x_3)\ldots(x_2 - x_m)} + \stopformula
  \startformula \ldots + f(x_m)\frac{(x - x_1)(x - x_2)\ldots(x - x_{m - 1})}{(x_m - x_2)(x_m - x_3)\ldots(x_m - x_m)}\stopformula
...
\item Show that if $f(x)$ is a polynomial whose degree is less than $m$, then the function $\frac{f(x)}{(x - x_1)(x - x_2)\ldots(x
  ...
  fractions
  \startformula \frac{A_1}{x - x_1} + \frac{A_2}{x - x_2} + \ldots + \frac{A_m}{x - x_m}\stopformula
  where $A_1, A_2, \ldots, A_m$ are independent of $x$.
\item Solve the system of equations
  \startformula \frac{x_1}{a_1 - b_1} + \frac{x_2}{a_1 - b_2} + \ldots + \frac{x_n}{a_1 - b_n} = 1\stopformula
  \startformula \frac{x_1}{a_2 - b_1} + \frac{x_2}{a_2 - b_2} + \ldots + \frac{x_n}{a_2 - b_n} = 1\stopformula
  \startformula \ldots\stopformula
  \startformula \frac{x_1}{a_n - b_1} + \frac{x_2}{a_n - b_2} + \ldots + \frac{x_n}{a_n - b_n} = 1\stopformula
\stopitemize
