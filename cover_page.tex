...
%       draw anchored.lrt(image(draw textext("\getvariable{document}{titleC}")  xsized(.750PaperWidth)      withcolor white),(lrcorner Page) shifted (-PaperWidth/20, PaperWidth/5)) ;
        ...
        draw function(2,"x","-1/exp(x)",-5,6.6,.1) xyscaled(1cm, 1cm) shifted z withcolor \MPcolor{purple};
        draw function(2,"x","-x*x + x + 4",-5,5,.1) xyscaled(1cm, 1cm) shifted z withcolor \MPcolor{purple};
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

  {
    ...
    Copyright, \copyright~ Dayashru, 2023. All rights reserved.\\\\
