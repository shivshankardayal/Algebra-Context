...
\startformula 2S_n = [2a + (n - 1)d] + [2a + (n - 1)d] + \ldots\text{~to~}n\text{~terms~}\stopformula
...
\startformula = \frac{7}{10} + \frac{7}{100} + \frac{7}{1000} + \ldots\stopformula
\startformula = \frac{7}{10} + \frac{7}{10^2} + \frac{7}{10^3} + \ldots\stopformula
\startformula = 7\left(\frac{1}{10} + \frac{1}{10^2} + \frac{1}{10^3} + \ldots\right)\stopformula
...
\item If $S_1, S_2, S_3, \ldots, S_p$ be the sum of $n$ terms of arithmetic progressions whose first terms are respectively $1, 2,
  3, \ldots$ and common differences are $1, 2, 3, \ldots$ prove that \startformula S_1 + S_2 + S_3 + \ldots + S_p = \frac{np}{4}(n+1)(p+1)\stopformula
...
\item If $\displaystyle S_\lambda = \sum_{r=0}^\infty \frac{1}{\lambda^r},$ then find $\sum_{\lambda = 1}^n(\lambda - 1)S_\lambda$.
...
\item If $a_1, a_2, \ldots, a_n$ are in A.P. where $a_i > 0\,\forall i,$ show that \startformula \frac{1}{\sqrt{a_1} + \sqrt{a_2}} +
  \frac{1}{\sqrt{a_2} + \sqrt{a_3}} + \ldots + \frac{1}{\sqrt{a_{n - 1}} + \sqrt{a_n}} = \frac{n - 1}{\sqrt{a_1} + \sqrt{a_n}}\stopformula
...
\item Solve the following equations for $x$ and $y$
  \startformula \log_{10}x + \log_{10}x^{1/2} + \log_{10}x^{1/4} + \ldots = y\stopformula
  \startformula \frac{1 + 3 + 5 + (2y - 1)}{4 + 7 + 10 + \ldots + 3y + 1} = \frac{20}{7\log_{10}x}\stopformula
