...
\startformula 2S_n = n[2a + (n - 1)d]\Rightarrow S_n = \frac{n}{2}[2a + (n - 1)d]\stopformula

We also see that $S_n = \frac{n}{2}(t_1 + t_n)$

We also see that if a series is $\displaystyle 1 + 2 + 3 + \cdots + n = \sum_{i=0}^ni = \frac{n(n + 1)}{2}$.
...
We observe that
\startformula i^3 - (i - 1)^3 = 3i^3 - 3i + 1 \Rightarrow \sum_{i = 1}^n[i^3 - (i - 1)^3] = 3\sum_{i = 0}^ni^2 - \frac{3n(n + 1)}{2} + n\stopformula
\startformula n^3 = 3\sum_{i = 0}^ni^2 - \frac{3n(n + 1)}{2} + n \Rightarrow 3\sum_{i=0}^ni^2 = n^3 + \frac{3n(n + 1)}{2} - n\stopformula
\startformula\sum_{i=0}^ni^2 = \frac{n(n + 1)(2n + 1)}{6}\stopformula

Following in a similar fashion, we can show that

\startformula\sum_{i=0}^n = \left\{\frac{n(n + 1)}{2}\right\}^2\stopformula
...
\item Find the value of $x$ in $]-\pi, \pi[$ which satisfy the equation $8^{1 + |\cos x| + \cos^2 x + |\cos^3 x| + \cdots
      \text{~to~}\infty} = 64$.
...
\item If $e^{{\sin^2x + \sin^4x + \sin^6x + \cdots \infty}\log_e2}$ satisfies the equation $x^2 - 9x + 8 = 0,$ find the
...
\item If $-\frac{\pi}{2} < x < \frac{\pi}{2}$ and the sum to infinite number of terms of series $\cos x + \frac{2}{3}\cos
  ...
  \frac{\pi}{2}\right)$
\item Suppose $0 < x < \pi$ and the expression $e^{{1 + |\cos x| + \cos^2x + |\cos^3x| + \cdots \infty}\log_e 4}$
