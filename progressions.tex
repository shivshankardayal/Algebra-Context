...
\placeformula[eq:progression-sn]\startformula S_n = \frac{n}{2}[2a + (n - 1)d]\stopformula

We also see that $S_n = \frac{n}{2}(t_1 + t_n)$

We also see that if a series is \placeformula[eq:progression-nn]]\startformula\displaystyle 1 + 2 + 3 +
...
\placeformula[eq:progression:amn]\startformula A_n = \frac{a + nb}{n + 1}\stopformula
...
We observe that
\placeformula[eq:progressions:ss]\startformula i^3 - (i - 1)^3 = 3i^3 - 3i + 1 \Rightarrow \sum_{i = 1}^n[i^3 - (i - 1)^3] = 3\sum_{i = 0}^ni^2 - \frac{3n(n + 1)}{2} + n\stopformula
\startformula n^3 = 3\sum_{i = 0}^ni^2 - \frac{3n(n + 1)}{2} + n \Rightarrow 3\sum_{i=0}^ni^2 = n^3 + \frac{3n(n + 1)}{2} - n\stopformula
\placeformula[eq:progressions:sc]\startformula\sum_{i=0}^ni^2 = \frac{n(n + 1)(2n + 1)}{6}\stopformula

Following in a similar fashion, we can show that

\placeformula[eq:progressions:sn]\startformula\sum_{i=0}^n = \left\{\frac{n(n + 1)}{2}\right\}^2\stopformula
