...
We observe that
\placeformula\startformula i^3 - (i - 1)^3 = 3i^3 - 3i + 1 \Rightarrow \sum_{i = 1}^n[i^3 - (i - 1)^3] = 3\sum_{i = 0}^ni^2 - \frac{3n(n + 1)}{2} + n\stopformula
...
\placeformula\startformula\sum_{i=0}^n = \left\{\frac{n(n + 1)}{2}\right\}^2\stopformula
