...
\setupbackend
  ...
  \setupbodyfont[10pt] % The document's main (body) font
...
%      location=middle
  ...
  \definecolor [maincolor] [r=,g=.5,b=.7] % Title colour

  \definecolor [purple] [r=0,g=0.5,b=.7] % Cover colour
