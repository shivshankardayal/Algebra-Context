...
\item Consider the following diagram:
  ...
  \vskip .8cm
\item From these two equation we have $r = \frac{c - a}{b - a}$ and $r = \frac{\omega - u}{v -u}$. Equating
...
\item From given equation, $\left(\frac{\left|z-1\right| + 4}{3\left|z - 1\right| + 2}\right) < \frac{1}{2}$
  ...
  $\Rightarrow |z - 1| > 0$. This represents area which lies outside a circle with center at $(1, 0)$ and
  radius $10$.
...
\item The diagram is given below:
  ...
  Clearly, $OCP$ is a right angle triangle. $\Rightarrow OC^2 = OP^2 + CP^2 \Rightarrow OP = 20. \therefore
  z = 20\left(\frac{3}{5}\right + i\frac{4}{5}\right) = 12 + 16i$.
  \vskip .7cm
...
\item Let $1 + \sin\phi + i \cos\phi = r(\cos\theta + i \sin\theta) \therefore 1 + \sin\phi = r\cos\theta$
  ...
  $\therefore \theta = \frac{\pi}{4} - \frac{\phi}{2}\;\therefore 2n\theta = \left(\frac{n\phi}{2} -
...
\item Let $C = \cos\theta \cos\theta + \cos^2\theta \cos 2\theta + \cdots + cos^n\theta \cos n\theta$
  ...
  $C = \cos\theta \sin\theta + \cos^2\theta \sin 2\theta + \cdots + cos^n\theta \sin n\theta$
...
\item $S + iS' = \displaystyle\sum_{k=0}^nC_k^^n(\cos k\theta + i\sin k\theta) = \sum_{k = 0}^^n(\cos\theta
  + i\sin\theta)^k = (1 + \cos\theta + i\sin\theta)^n$

  $= \left[2\cos^2\frac{\theta}{2} + 2i\sin\frac{\theta}{2}\cos\frac{\theta}{2}\right]^n =
  2^n\cos^n\frac{\theta}{2}\left(\cos\frac{\theta}{2}\right + i\sin\frac{\theta}{2})^n$
...
\item Considering $2n + 1$th root of unity $x_s = \cos\frac{(2s + 1)\pi}{2n + 1} + i\sin\frac{(2s +
...
\item Considering $2n + 1$th root of $-1, x_s = -\cos\frac{(2s + 1)\pi}{2n + 1} + i\sin\frac{(2s +
  1)\pi}{2n + 1}\;\;(s = 1, 2, 3, \ldots, n)$.
  Therefore $x^{2n + 1} + 1 = \displaystyle\prod_{s = 1}^{2n + 1}(x - x_s)$. However, $x_{2n + 1} = -1$,
  therefore
